  ...
  return (
    <div className="w-full max-w-3xl p-4">
      ...
      <section className="flex gap-1 text-white">
        <div className="bg-primary p-4 py-10  rounded-lg w-1/2">
          <p className="text-2xl font-bold">14</p>
          <h3 className="font-semibold text-lg">Clientes nuevos</h3>
        </div>
        <div className="bg-strongBlue p-4 py-10  rounded-lg w-1/2">
